...
set JAVA_ARG=
set LIBREC_MAIN=com.bbtree.librec.tool.driver.DataDriver
...
if "%~1" equ "--version" goto ECHO_VERSION
rem GET LIBREC_MAIN
if "%~1" equ "data" (set LIBREC_MAIN=com.bbtree.librec.tool.driver.DataDriver)
if "%~1" equ "rec" (set LIBREC_MAIN=com.bbtree.librec.tool.driver.RecDriver)
