 ...
 */
package com.bbtree.librec.data.model;

import com.bbtree.librec.BaseTestCase;
import com.bbtree.librec.common.LibrecException;
import com.bbtree.librec.conf.Configured;
import com.bbtree.librec.data.DataModel;
...
/**
 * TextDataMode TestCase {@link com.bbtree.librec.data.model.TextDataModel}
 *
...
public class TextDataModelTestCase extends BaseTestCase {
	 ...
	 * {@link com.bbtree.librec.data.convertor.TextDataConvertor} input data subject to
	...
	/**
	 * test the function of convertor part
	 * {@link com.bbtree.librec.data.convertor.TextDataConvertor} read all files in the
	...
	/**
	 * test the function of convertor part
	 * {@link com.bbtree.librec.data.convertor.TextDataConvertor} test three different
	 * types of CSV : "," " " and "\t"
	 * 
	 * @throws LibrecException
	 */
	 ...
	 * {@link com.bbtree.librec.data.splitter.RatioDataSplitter} split the data by
	 * rating ratio
	 * 
	 * @throws LibrecException
	 */
	...
	/**
	 * test the function of splitter part
	 * {@link com.bbtree.librec.data.splitter.RatioDataSplitter} split the data by user
	 * ratio
	 *
	 * @throws LibrecException
	 */
	...
	/**
	 * test the function of splitter part
	 * {@link com.bbtree.librec.data.splitter.RatioDataSplitter} split the data by item
	 * ratio
	 *
	 * @throws LibrecException
	 */
	...
	/**
	 * Test the function of splitter part.
	 * {@link com.bbtree.librec.data.splitter.RatioDataSplitter} Sort all ratings by
	...
	/**
	 * Test the function of splitter part.
	 * {@link com.bbtree.librec.data.splitter.RatioDataSplitter} Sort each user's
	...
	/**
	 * Test the function of splitter part.
	 * {@link com.bbtree.librec.data.splitter.RatioDataSplitter} Sort each item's
	...
	/**
	 * Test the function of splitter part.
	 * {@link com.bbtree.librec.data.splitter.KCVDataSplitter} Split all ratings for
	...
	public void test12KCV() throws LibrecException {
		conf.set("data.model.splitter", "com.bbtree.librec.data.splitter.KCVDataSplitter");
	...
	/**
	 * Test the function of splitter part.
	 * {@link com.bbtree.librec.data.splitter.LOOCVDataSplitter} Each user splits out a
	...
	public void test13LOOByUser() throws LibrecException {
		conf.set("data.model.splitter", "com.bbtree.librec.data.splitter.LOOCVDataSplitter");
	...
	/**
	 * Test the function of splitter part.
	 * {@link com.bbtree.librec.data.splitter.LOOCVDataSplitter} Each item splits out a
	 * rating for test set,the rest for train set.
	 *
	 * @throws LibrecException
	 */
	...
	/**
	 * Test the function of splitter part.
	 * {@link com.bbtree.librec.data.splitter.GivenNDataSplitter} Each user splits out
	...
	public void test17GivenNByUser() throws LibrecException {
		conf.set("data.model.splitter", "com.bbtree.librec.data.splitter.GivenNDataSplitter");
	...
	/**
	 * Test the function of splitter part.
	 * {@link com.bbtree.librec.data.splitter.GivenNDataSplitter} Each item splits out
	 * N ratings for test set,the rest for training set.
	 *
	 * @throws LibrecException
	 */
	...
	/**
	 * Test the function of splitter part.
	 * {@link com.bbtree.librec.data.splitter.GivenNDataSplitter} each user split out N
	...
	/**
	 * Test the function of splitter part.
	 * {@link com.bbtree.librec.data.splitter.GivenNDataSplitter} Each item split out N
	 * ratings with biggest value of date for test set,the rest for training
	 * set.
	 *
	 * @throws LibrecException
