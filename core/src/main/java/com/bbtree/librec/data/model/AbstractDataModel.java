...
public abstract class AbstractDataModel extends Configured implements DataModel {
    ...
    /** The convertor of the model {@link com.bbtree.librec.data.DataConvertor} */
    protected DataConvertor dataConvertor;

    /**
     * Data Splitter {@link com.bbtree.librec.data.DataSplitter}
     */
     ...
     * Get data context.
     *
     * @return the context see {@link com.bbtree.librec.data.DataContext}.
     */
    @Override
