 ...
 */
package com.bbtree.librec.recommender.cf;

import com.bbtree.librec.annotation.ModelData;
import com.bbtree.librec.common.LibrecException;
import com.bbtree.librec.math.structure.DenseVector;
import com.bbtree.librec.math.structure.SparseVector;
import com.bbtree.librec.math.structure.SymmMatrix;
import com.bbtree.librec.math.structure.VectorEntry;
import com.bbtree.librec.recommender.AbstractRecommender;
import com.bbtree.librec.util.Lists;
...
public class UserKNNRecommender extends AbstractRecommender {
     ...
     * (non-Javadoc)
     *
     * @see com.bbtree.librec.recommender.AbstractRecommender#setup()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.bbtree.librec.recommender.AbstractRecommender#trainModel()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.bbtree.librec.recommender.AbstractRecommender#predict(int, int)
     */
    @Override
